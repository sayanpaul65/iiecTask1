...
print("\t\t\t\t Hey! I am Harry, your system's personal Assistant")
print("\t\t\t\t -------------------------------------------------")
pyttsx3.speak("Hey! I am Harry, your system's personal Assistant")

print()
print("\t\t\t\t Welcome to Harry's World (Menu Based Service BOT) \t\t\t")
print("\t\t\t\t -------------------------------------------------")
pyttsx3.speak("Welcome to Harry's World (Menu Based Service BOT)")
